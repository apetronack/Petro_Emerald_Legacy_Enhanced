...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Lairon = {TAG_NONE, OBJ_EVENT_PAL_TAG_LAIRON, OBJ_EVENT_PAL_TAG_NONE, 512, 32, 32, 2, SHADOW_SIZE_M, FALSE, OW_GFX_COMPRESS, TRACKS_FOOT, &gObjectEventBaseOam_32x32, sOamTables_32x32, sAnimTable_Following, sPicTable_Lairon, gDummySpriteAffineAnimTable};