...
extern const u8 gText_Tutor_MegaPunch[];
extern const u8 gText_Tutor_MegaKick[];
extern const u8 gText_Tutor_BodySlam[];
extern const u8 gText_Tutor_RockSlide[];
extern const u8 gText_Tutor_Counter[];
extern const u8 gText_Tutor_DynamicPunch[];
extern const u8 gText_Tutor_SwordsDance[];
extern const u8 gText_Tutor_MudSlap[];
extern const u8 gText_Tutor_SeismicToss[];
extern const u8 gText_Tutor_Endure[];
extern const u8 gText_Tutor_FirePunch[];
extern const u8 gText_Tutor_IcePunch[];
extern const u8 gText_Tutor_ThunderPunch[];
